...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN ASU!?
            ...
            + 'FN:Billa Chan\n' // NAMA OWNER BOT
            + 'ORG:Creator YOKSOBOT;\n' // KASIH CREDITS GUA FADHIL GRAPHY SU!!!
            + 'TEL;type=CELL;type=VOICE;waid=6285742605040:+6285742605040\n' // GANTI NOMOR LU
            + 'END:VCARD'
prefix = '/'
blocked = []
			...
			case 'owner':
               ...
               case 'infogempa':
			    ...
			    case 'igstalk':
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://freerestapi.herokuapp.com/api/v1/igs?u=`, {method: 'get'})
